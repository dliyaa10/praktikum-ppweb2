...
<body>
    ...
    <main role="main" class="container mt-3">
        ...
        <form class="mx-auto" action="form_nilai_get.php" method="GET">
            ...
            <div class="form-group row">
                <label for="matkul"name="matkul" class="col-5 col-form-label font-weight-bold text-right">Mata Kuliah</label>
                <div class="col-7">
            ...
            <div class="form-group row">
                <label for="nilai_tugas" name="nilai_tugas" class="col-5 col-form-label font-weight-bold text-right">Nilai Tugas/Praktikum</label>
                <div class="col-7">
